...
dwdrift = 0.4  # diamond wall drift align.
hwalign = 0.3  # honey wall align.
...
def dy_walk(leng, dir1, dir2 = False): #Electro too lazy to change from ahk to py
    if dir2 == False:
        self.keyboard.walk(dir1, leng)
    else:
        self.keyboard.multiWalk([dir1, dir2], leng)

stop = [False & digi, True & digi]
for stops in stop:
    dy_walk(h, leftkey)
    dy_walk(s, fwdkey)
    dy_walk(l, rightkey)
